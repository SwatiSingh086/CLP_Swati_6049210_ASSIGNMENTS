...
//controller level exception handling-writing handling code in one controller
//if u have multiple controllers-global level exception handling
...
public class TraineeController {
   ...
   // ResponseEntity<String> handlerForIdNotFoundException(TraineeNotFoundException e){
